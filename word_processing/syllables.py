# TODO придумать как улучшить и написать свое
# Взято из https://github.com/IlyaGusev/russ/blob/master/russ/syllables.py
...
class Syllable(Annotation):
    ...
    def __str__(self):
        return f'{self.text} {"" if self.stress == -1 else "(ударный)"}'
